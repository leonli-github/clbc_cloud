...
var instantiateChaincode = function(/*peersUrls, */channelName, chaincodeName, chaincodeVersion, functionName, args, username, org) {
	...
	return helper.getOrgAdmin(org).then((user) => {
		...
		var request = {
			/*targets: targets,
			'endorsement-policy': endorsementPolicy1,*/
